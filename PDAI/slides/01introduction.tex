...
\begin{frame}{Note on the 3-modules structure}
	\begin{block}{3-modules structure: %\myurl{\homepage}
		}
...
\begin{frame}{Sneak preview of Module 2  PM - THIS A.Y.}
	...
	\begin{block}{M2-PM (Process mining)}
		This is a hot topic. With interest in academia and in industry. Interdisciplinary research.	
	\end{block}
	\includegraphics[width=0.9\linewidth]{figures/pm/icpm24.png}
...
\begin{frame}{Sneak preview of Module 2  PM - THIS A.Y.}
	...
	\begin{block}{M2-PM (Process mining)}
		This is a hot topic. With interest in academia and in industry. Interdisciplinary research.	
	\end{block}
	\includegraphics[width=0.3\linewidth]{figures/pm/diamond.png}
		\includegraphics[width=0.3\linewidth]{figures/pm/gold.png}
				\includegraphics[width=0.3\linewidth]{figures/pm/startup.png}
\end{frame}
